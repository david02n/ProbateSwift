...
## Status: superseded as v1 direction
[[dec-iht-form-strategy]] (David, 2026-06-11) chose **guided completion** ([[sol-guided-iht400]]) over signposting. This node stays as the *current shipped* behaviour and a fallback for the heaviest schedules, but is no longer the target v1 model.

## Trade-offs
Solves "do I need IHT400 / which forms" but not "help me actually complete IHT400" — no field-level prefill from the estate data already captured. That richer step is [[sol-guided-iht400]], now the chosen direction.
